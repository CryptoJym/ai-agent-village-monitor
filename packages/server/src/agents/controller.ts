...
export interface MCPAgentController {
  ...
  runCommand(agentId: string | number, command: string, args?: CommandArgs, opts?: RunCommandOptions): Promise<CommandResult>;
  runTool?(agentId: string | number, tool: string, params?: Record<string, unknown>, opts?: RunCommandOptions): Promise<CommandResult>;
  runTask?(agentId: string | number, description: string, opts?: RunCommandOptions): Promise<CommandResult>;
...
export class MockMCPAgentController implements MCPAgentController {
  ...
  async runCommand(_agentId: string | number, command: string, args?: CommandArgs, opts?: RunCommandOptions): Promise<CommandResult> {
  ...
  async runTool(_agentId: string | number, tool: string, params?: Record<string, unknown>, opts?: RunCommandOptions): Promise<CommandResult> {
  ...
  async runTask(_agentId: string | number, description: string, opts?: RunCommandOptions): Promise<CommandResult> {
